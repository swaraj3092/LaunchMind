...
- **🦈 Virtual VC Pitch Room**: Practice defending your idea live against 3 distinct AI venture capitalists: Marcus Vance (Lead Partner), Elena Rostova (Growth Partner), or Dr. Aris Thorne (Deep Tech Partner). Experience a 4-round real-time pitch session with live score updates based on your responses.
- **📊 Market Intelligence Dashboard**: Interactive Recharts TAM/SAM/SOM donut sizing and competitor benchmarking bar charts, keeping your market research visually striking and clear.
- **🏆 Venture Readiness Score**: AI-scored readiness (0-100) across 4 dimensions: Market Opportunity, Execution Clarity, Innovation Factor, and Team Fit.
- **🗂️ AI Pitch Deck Generator**: Converts your plan instantly into a 10-slide outline complete with headlines, bullet points, and speaker notes, copyable with a single click.
- **🎭 Offline Resiliency (Demo Mode)**: Automatically falls back to high-fidelity simulated questions, roadmap templates, and mock VC conversations if the backend server is offline.
- **💾 Session Persistence**: Automatically saves and restores your progress in localStorage.
